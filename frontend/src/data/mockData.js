...
export const MENU_ITEMS = [
  ...
  { id: 15, category_id: 3, name: 'Tacos dallas gratinée',  price: 50, image: '/imageMenu/tacos.webp', featured: true },
  ...
  // Nos Pizzas
  { id: 22, category_id: 6, name: 'Pezza Dallas',         price: 50, image: '/imageMenu/pezza-dallas.webp',           featured: true },
  { id: 23, category_id: 6, name: 'Pizza classique',       price: 48, image: '/imageMenu/pizza.webp',                  featured: false },

  // Avec photos
  { id: 24, category_id: 1, name: 'Bogitos poulet gratiné', price: 33, image: '/imageMenu/bogitos-poulet-gratine.webp', featured: true },
  { id: 25, category_id: 1, name: 'Chabatii poule',         price: 30, image: '/imageMenu/chabatii-poule.webp',         featured: true },
];

export const GALLERY = [
  { id: 1,  image_url: '/imageMenu/cafe-interieur.webp',         caption: 'Notre salle chaleureuse',       category: 'ambiance' },
  { id: 2,  image_url: '/imageMenu/cafe-ambiance.webp',          caption: 'Ambiance Café Dallas',          category: 'ambiance' },
  { id: 3,  image_url: '/imageMenu/bogitos-poulet-gratine.webp', caption: 'Bogitos poulet gratiné',        category: 'food' },
  { id: 4,  image_url: '/imageMenu/chabatii-poule.webp',         caption: 'Chabatii poule',                category: 'food' },
  { id: 5,  image_url: '/imageMenu/pezza-dallas.webp',           caption: 'Pezza Dallas',                  category: 'food' },
  { id: 6,  image_url: '/imageMenu/pizza.webp',                  caption: 'Pizza classique',               category: 'food' },
  { id: 7,  image_url: '/imageMenu/tacos.webp',                  caption: 'Tacos Dallas',                  category: 'food' },
  { id: 8,  image_url: '/imageMenu/AllMenu.webp',                caption: 'Notre carte complète',          category: 'menu' },
];
